...
function setupCss() {
    ...
    $("#step0-try, #step1-retry, #end-call, #send-mail-link").hover(
        function() { 
            $(this).css({ 'border-bottom':'4px solid #bcd337', 'background-color':'#473f47'}) 
        },
        function() { 
            $(this).css({ 'border-bottom':'4px solid #34233f', 'background-color':'#34233f'}) 
    });
